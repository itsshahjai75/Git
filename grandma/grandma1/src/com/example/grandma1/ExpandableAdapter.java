...
public class ExpandableAdapter extends BaseExpandableListAdapter {
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		TextView itemName = (TextView) v.findViewById(R.id.content);
		TextView med = (TextView) v.findViewById(R.id.mediname);
		TextView itemDescr = (TextView) v.findViewById(R.id.description);
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		TextView groupName = (TextView) v.findViewById(R.id.medi);
