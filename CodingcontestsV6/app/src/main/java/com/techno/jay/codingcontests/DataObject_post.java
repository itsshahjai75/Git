...
public class DataObject_post {
    ...
    public DataObject_post(String duration, String end, String start, String event, String href, String contestid, String resource_id, String resource_name,String reminderstatus) {
        this.duration = duration;
        this.end = end;
        this.start = start;
        this.event = event;
