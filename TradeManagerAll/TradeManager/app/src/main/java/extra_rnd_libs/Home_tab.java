...
import Adapters.SimpleFragmentStatePagerAdapter;
import manager.trade.techno.trademanager.AbstractPageChangedListener;
import manager.trade.techno.trademanager.R;

public class Home_tab extends AppCompatActivity implements OnItemClickListener {
    ...
    public static void start(Context context, int orientation) {
        Intent starter = new Intent(context, Home_tab.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        categoriesAdapter = new SimpleCategoriesAdapter(MockedItemsFactory_Custom.getCategoryItemsUniq());
