...
public class Technical_central_result extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("got branch ID---",get_intent);
                ...
                String url_codejam="http://webappfirm.com/felicific/coding.json";
        String url_robo="http://webappfirm.com/felicific/robotics.json";
        String url_hunt="http://webappfirm.com/felicific/huntronics.json";
        String url_game="http://webappfirm.com/felicific/centralgaming.json";
