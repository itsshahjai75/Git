...
public class TransmoreAdapter2 extends BaseAdapter  {
	...
	public TransmoreAdapter2(Activity activity, List<TransMoreData> movieItems) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null)
			convertView = inflater.inflate(R.layout.del_trans_row, null);
