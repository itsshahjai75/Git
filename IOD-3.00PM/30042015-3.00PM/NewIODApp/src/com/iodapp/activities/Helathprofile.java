...
import com.iodapp.activities.AdditionalDetails.SelectDateFragment;
import com.iodapp.activities.AdditionalDetails.get_details;
...
public class Helathprofile extends FragmentActivity implements OnItemSelectedListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sysFont = Typeface.createFromAsset(getAssets(),"font/Leelawadee.ttf");
 		...
 		TextView btn_skip= (TextView)this.findViewById(R.id.btnSkip);
        
        if(data.getString("skipshow", "NO").equalsIgnoreCase("yes")){
		...
		Intent a = new Intent(Helathprofile.this,DashboardActivity.class);
		startActivity(a);
 ...
 adpter_gender = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, gen);
        ...
        System.out.println("customer Id======"+Sharedpref.getcustomerid());
    ...
    public void onBackPressed() {
    	// TODO Auto-generated method stub
    	super.onBackPressed();
    	data.edit().putString("skipshow", "no").commit();
...
//			
			...
			if(Integer.parseInt(result) > 0)
			{
				...
				Intent it_login = new Intent(Helathprofile.this,
						MyAccount.class);
				Bundle bndlanimation = ActivityOptions.makeCustomAnimation(
						Helathprofile.this, R.anim.animation,
			...
			{
				pDialog.cancel();
				Toast.makeText(Helathprofile.this, "Error Occure When Data Upadate", Toast.LENGTH_SHORT).show();
			}
	...
	private static String convertInputStreamToString(InputStream inputStream)
	 ...
	 class get_details extends AsyncTask<String, Void, String> {
	        ...
	        protected void onPreExecute()
	        {
	            ...
	            progressDialog = ProgressDialog.show(Helathprofile.this, "Loading", "Please Wait--------.", true, false);
	        }
