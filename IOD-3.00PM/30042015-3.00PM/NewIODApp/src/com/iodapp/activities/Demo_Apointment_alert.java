...
public class Demo_Apointment_alert extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {		
		...
		final String time = getIntent().getStringExtra("appoint_time");
		final String date = getIntent().getStringExtra("appoint_date");
	//	final String note = getIntent().getStringExtra("note");
		final int pendingintent_id = getIntent().getIntExtra("pendindintent_id", 1);
	...
	try {
	     ...
	     e.printStackTrace();
	     	...
	     	/*/* Turn Screen On and Unlock the keypad when this alert dialog is displayed */
	         	Demo_Apointment_alert.this.getWindow().addFlags(LayoutParams.FLAG_TURN_SCREEN_ON |LayoutParams.FLAG_SHOW_WHEN_LOCKED | LayoutParams.FLAG_DISMISS_KEYGUARD);
	     		
	     		
	     		/* Creating a alert dialog builder */
	     		AlertDialog.Builder builder = new AlertDialog.Builder(Demo_Apointment_alert.this);
	     		
	     		
	     		/** Setting title for the alert dialog */
	     		builder.setTitle("Appointment Reminder...");
	     		builder.setIcon(R.drawable.app_icon);
	     		
	     		/** Setting the content for the alert dialog */
	     		builder.setMessage("Dear\n"+Sharedpref.getfirstname()+"\nYou have an Appointmnet now on Time: "+time+" & Date: "+date+"\nKindly keep available within 2-5 min.");
	     		...
	     		builder.setPositiveButton("Cancel Reminder.", new OnClickListener() {
	     			...
	     			public void onClick(DialogInterface dialog, int which) {
	     				/** Exit application on click OK */
							...
							Intent i = new Intent(Demo_Apointment_alert.this,Demo_medi_alert.class);
							...
							Toast.makeText(getBaseContext(), "Reminder is Canceled successfully ,Appointment Reminder Cancled.",Toast.LENGTH_LONG).show();
									mp.stop();
	     		...
	     		builder.setNeutralButton("Snooze for 10 Min.", new OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
	    				...
	    				Intent i = new Intent(Demo_Apointment_alert.this,Demo_medi_alert.class);
	    				i.putExtra("appoint_time",time );
						i.putExtra("appoint_date",date );
						i.putExtra("pendindintent_id",pendingintent_id );
