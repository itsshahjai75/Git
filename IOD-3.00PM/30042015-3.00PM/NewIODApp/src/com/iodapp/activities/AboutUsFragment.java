...
public class AboutUsFragment extends Fragment {
	...
	private ImageButton aboutus_back;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		aboutus_back = (ImageButton) rootView.findViewById(R.id.btn_back_AboutUs);
		setSystemFont();
		
		
		new HttpAsyncTask()
				.execute("http://jsoncdn.webcodeplus.com/ContentData.svc/ContentDetailsFromContentID/30/821");
		return rootView;
