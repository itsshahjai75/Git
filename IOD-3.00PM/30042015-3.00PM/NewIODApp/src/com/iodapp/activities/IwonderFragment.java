...
public class IwonderFragment extends Fragment {
	
	TextView etResponse;
	private ProgressBar progressBar;
	
	public IwonderFragment(){}
	
	@Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
            Bundle savedInstanceState) {
 
        View rootView = inflater.inflate(R.layout.fragment_iwonder, container, false);
        etResponse = (TextView) rootView.findViewById(R.id.etResponse);
		progressBar = (ProgressBar) rootView.findViewById(R.id.progressBar1);
		new HttpAsyncTask()
				.execute("http://jsoncdn.webcodeplus.com/ContentData.svc/ContentDetailsFromContentID/30/817");
        return rootView;
    }
