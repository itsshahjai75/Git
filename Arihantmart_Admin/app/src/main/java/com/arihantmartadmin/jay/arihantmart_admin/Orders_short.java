...
public class Orders_short extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orders_short);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                str_ordernumber=query;


                Intent order = new Intent(Orders_short.this,All_ordres.class);
                order.putExtra("orderno",query);
                startActivity(order);
        ...
        if (isInternetPresent) {
            ...
            Toast.makeText(Orders_short.this, "  No Internet Connection!!!.  ", Toast.LENGTH_LONG).show();
    ...
    class GetAllOrders extends AsyncTask<Object, Void, String> {
        ...
        protected void onPreExecute()//execute thaya pela
        {
            ...
            progressDialog = ProgressDialog.show(Orders_short.this, "Loading", "Please Wait...", true, false);
        ...
        protected String doInBackground(Object... parametros) {
            ...
            try{
                ...
                HttpPost post = new HttpPost("http://arihantmart.com/androidapp/allordersadmin.php");
...
//            progressDialog.dismiss();
        ...
        protected void onPostExecute(String result)
        {
            ...
            if (res == null || res.equals("")) {
                ...
                progressDialog.dismiss();
                Toast.makeText(Orders_short.this, "Network connection ERROR or ERROR", Toast.LENGTH_LONG).show();
                return;
            }
