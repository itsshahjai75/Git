...
public class All_ordres extends AppCompatActivity {
    ...
    String res,user_email,str_ordernumber;
    TextView tv_summary;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_all_ordres);
        ...
        String order_no = getIntent().getStringExtra("orderno");
        str_ordernumber=order_no;




        results = new ArrayList<DataObject_Orderlist>();
        adapter = new MyRecyclerAdapter_Orderlist(results, this);
        ...
        if (isInternetPresent) {
            ...
            new GetOrdersbyordernumber().execute();
            ...
            Toast.makeText(All_ordres.this, "  No Internet Connection!!!.  ", Toast.LENGTH_LONG).show();
    ...
    class GetOrdersbyordernumber extends AsyncTask<Object, Void, String> {
        ...
        protected void onPreExecute()//execute thaya pela
        {
            ...
            progressDialog = ProgressDialog.show(All_ordres.this, "Loading", "Please Wait...", true, false);
        ...
        protected String doInBackground(Object... parametros) {
            ...
            try{
                ...
                HttpPost post = new HttpPost("http://arihantmart.com/androidapp/allorderadminbyordernumber.php?order_number="+str_ordernumber);
...
//            progressDialog.dismiss();
        ...
        protected void onPostExecute(String result)
        {
            ...
            if (res == null || res.equals("")) {
                ...
                progressDialog.dismiss();
                Toast.makeText(All_ordres.this, "Network connection ERROR or ERROR", Toast.LENGTH_LONG).show();
                return;
            }
            ...
            try {
                ...
                for (int j = 0; j < array_res.length(); j++) {
                    ...
                    order_time = new SimpleDateFormat("dd/MM/yyyy hh:mm aa", Locale.getDefault()).format(date_post.getTime());
                    ...
                    DataObject_Orderlist obj1 = new DataObject_Orderlist(order_number ,order_time, items, Integer.toString(PER_ITEM_TOTAL),Integer.toString(PER_ITEM_TOTATSAVE));
                    results.add(obj1);
                ...
                tv_summary.setText("Summary :\n"+"Total Business : ₹"+Total_cart_amount+"\nTotal Discounts : ₹"+Total_cart_saving_amount);
