...
public class Show_Set_Reminders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
                ...
                String selectQuery = "SELECT  * FROM " + DatabaseHelper.TABLE_NAME + " WHERE " + DatabaseHelper.REMINDER + " = '1';";
                ...
                if(mCursor==null || mCursor.getCount()<=0){
                    ...
                    DataObject_post obj12 = new DataObject_post("000000", "YYYY-MM-DD HH:mm:ss", "YYYY-MM-DD HH:mm:ss", "No Data Found Sorry.", null, null, null, "No Data Found Sorry.","0");
                    // Log.d("object",EVENT);
                    results.add(obj12);
                }
