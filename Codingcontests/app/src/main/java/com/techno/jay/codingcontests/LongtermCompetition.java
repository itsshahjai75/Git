    ...
    class Getlongcontests extends AsyncTask<Object, Void, String> {
        ...
        protected String doInBackground(Object... parametros) {
            ...
            try{
                ...
                URL obj = new URL("http://clist.by:80/api/v1/contest/?limit=2000&start__gt=2016-01-01&duration__gt=30%20days&order_by=-end&username=shah.jai75&api_key=434a1084d357751c87dbd1dc9a8e0885accdd30b");
            ...
            try {
                ...
                if (array_res.length() == 0) {
                    ...
                    for (int j = 0; j < array_res.length(); j++) {
                        ...
                        DataObject_post obj12 = new DataObject_post(duration, end, start, event, href, contestid, resource_id, resource_name,"0");
                        // Log.d("object",EVENT);
                        results.add(obj12);
