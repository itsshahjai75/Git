...
public class Sub_categorylist extends AppCompatActivity {
    ...
    String pemail,res2,res,str_catgry_name,str_catgry_id,str_imageresourse,str_keyword,str_sortby;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchView.setOnQueryTextListener(new MaterialSearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                Intent result = new Intent(Sub_categorylist.this, Sub_categorylist.class);
...
// Fetching the textview declared in footer.xml
        ...
        loadmore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(bool_sortyby){
                    new Sortbycatagoryitem_increment().execute();
                }else{
...
//            progressDialog.dismiss();
            ...
            try {
                ...
                if (array_res.length() == 0) {
                    ...
                    for (int j = 0; j < array_res.length(); j++) {
                        ...
                        DataObject_Itemlist obj10 = new DataObject_Itemlist(item_name + " ("+item_compnay_name+")", "MRP: ₹ "+mrp+"\nOur Price: ₹ "+our_price, str_imageresourse, "Saving : ₹ "+saving_amount,item_code);
                        results.add(obj10);
    ...
    class Sortbycatagoryitem extends AsyncTask<Object, Void, String> {
        ...
        protected String doInBackground(Object... parametros) {
            ...
            try{
                ...
                HttpClient client = new DefaultHttpClient();
                String query="http://arihantmart.com/androidapp/sortcatagory.php?catagoryname="+str_catgry_name+"&&shortby="+str_sortby;
                query=query.replaceAll(" ","%20");
                //Log.d("site",query);
                //String query = URLEncoder.encode("http://arihantmart.com/androidapp/itembycatgory.php?catagoryname="+str_catgry_name, "utf-8");
                HttpPost post = new HttpPost(query);
            ...
            try {
                ...
                if (array_res.length() == 0) {
                    ...
                    for (int j = 0; j < array_res.length(); j++) {
                        ...
                        DataObject_Itemlist obj123 = new DataObject_Itemlist(item_name + " ("+item_compnay_name+")", "MRP: ₹ "+mrp+"\nOur Price: ₹ "+our_price, str_imageresourse, "Saving : ₹ "+saving_amount,item_code);
                        results.add(obj123);
    ...
    class Sortbycatagoryitem_increment extends AsyncTask<Object, Void, String> {
        ...
        protected String doInBackground(Object... parametros) {
            ...
            try{
                ...
                load_count++;
                HttpClient client = new DefaultHttpClient();
                String query2="http://arihantmart.com/androidapp/sortcatagory_increment.php?loadcount="+load_count+"&&catagoryname="+str_catgry_name+"&&shortby="+str_sortby;
                query2=query2.replaceAll(" ","%20");
                //Log.d("URL",query2);
            ...
            try {
                ...
                if (array_res.length() == 0) {
                    ...
                    for (int j = 0; j < array_res.length(); j++) {
                        ...
                        DataObject_Itemlist obj1234 = new DataObject_Itemlist(item_name + " ("+item_compnay_name+")", "MRP: ₹ "+mrp+"\nOur Price: ₹ "+our_price, str_imageresourse, "Saving : ₹ "+saving_amount,item_code);
                        results.add(obj1234);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case  R.id.action_cart:
                startActivity(new Intent(this,CartProducts.class));
                overridePendingTransition(R.anim.slide_in_left, R.anim.slide_out_right);
            ...
            case R.id.sortby:
                ...
                final Dialog dialog = new Dialog(Sub_categorylist.this);
                ...
                final RadioGroup rg_sortby =(RadioGroup)dialog.findViewById(R.id.rg_sortby);
                rg_sortby.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(RadioGroup group, int checkedId)
                    {
                        ...
                        str_sortby= radioButton.getText().toString();
                        str_sortby=str_sortby.replace(" ","");
                        bool_sortyby=true;
                        new Sortbycatagoryitem().execute();
                       // Toast.makeText(getBaseContext(), str_sortby, Toast.LENGTH_SHORT).show();
                        dialog.dismiss();
                    }
                });
