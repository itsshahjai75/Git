...
public class Detail_orders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isInternetPresent) {
            ...
            Toast.makeText(Detail_orders.this, "  No Internet Connection!!!.  ", Toast.LENGTH_LONG).show();
    ...
    class GetOrdersbyordernumber extends AsyncTask<Object, Void, String> {
        ...
        protected void onPreExecute()//execute thaya pela
        {
            ...
            progressDialog = ProgressDialog.show(Detail_orders.this, "Loading", "Please Wait...", true, false);
...
//            progressDialog.dismiss();
        ...
        protected void onPostExecute(String result)
        {
            ...
            if (res == null || res.equals("")) {
                ...
                progressDialog.dismiss();
                Toast.makeText(Detail_orders.this, "Network connection ERROR or ERROR", Toast.LENGTH_LONG).show();
                return;
            }
