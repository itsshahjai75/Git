...
public class Otp_screren extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_otp_screren);
    ...
    public class UserLoginTask extends AsyncTask<Object, Void, String> {
        ...
        protected void onPreExecute()//execute thaya pela
        {
            ...
            progressDialog = ProgressDialog.show(Otp_screren.this, "Loading", "Please Wait--------.", true, false);
        ...
        protected String doInBackground(Object... parametros) {
            ...
            try{
                ...
                HttpPost post = new HttpPost("http://arihantmart.com/androidapp/check_otp.php?mobno="+str_mono+"&&otp="+str_otp);
        ...
        protected void onPostExecute(String result) {
            ...
            if (res == null || res.equals("")) {
                ...
                Toast.makeText(Otp_screren.this, "Network connection ERROR or ERROR", Toast.LENGTH_LONG).show();
                return;
            } else {
                try {
                    ...
                    if(response_string.contains("mobile & otp miss matched!")){


                        Snackbar snackbar = Snackbar
                                .make(findViewById(android.R.id.content), " mobile & otp miss matched  !!!", Snackbar.LENGTH_LONG);
                        ...
                        Toast.makeText(Otp_screren.this, "  mobile & otp miss matched !.  ", Toast.LENGTH_LONG).show();
                        ...
                        String display_name = array_res.getJSONObject(0).getString("name");


                        Intent reports = new Intent(Otp_screren.this, Home.class);
                        ...
                        sharepref.edit().putString("key_useremail", user_email).apply();
                        sharepref.edit().putString("key_usermobno", str_mono).apply();
                        sharepref.edit().putString("key_username", display_name).apply();
                        sharepref.edit().putString("key_userID", ID).apply();
