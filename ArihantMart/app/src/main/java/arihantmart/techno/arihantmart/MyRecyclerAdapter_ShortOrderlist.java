...
public class MyRecyclerAdapter_ShortOrderlist extends RecyclerView.Adapter<MyRecyclerAdapter_ShortOrderlist.ViewHolder> {
        ...
        public ViewHolder(final View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent order = new Intent(v.getContext(),Detail_orders.class);
            ...
            btn_return_wholeorder.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(str_useremail.equalsIgnoreCase("demo@demo.com")){
                        ...
                        alertbox.setMessage("Order will be cancel permanently.");
                        alertbox.setTitle("Cancel Order ?");
                        alertbox.setIcon(R.drawable.appicon);

                        alertbox.setNeutralButton("YES,Cancel",
    ...
    class Cancelorder extends AsyncTask<Object, Void, String> {
        ...
        protected String doInBackground(Object... parametros) {
            ...
            try{
                ...
                HttpPost post = new HttpPost("http://arihantmart.com/androidapp/cancelorderbyuser.php");
