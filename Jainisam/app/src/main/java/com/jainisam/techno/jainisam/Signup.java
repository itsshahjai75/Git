...
public class Signup extends AppCompatActivity {
    ...
    EditText et_name,et_mono,et_email,et_pwd,et_cnfpwd;
    Button btn_submit;

    String name,email,mobno,pwd,res;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      et_name = (EditText)this.findViewById(R.id.et_name);
        ...
        et_cnfpwd = (EditText)this.findViewById(R.id.et_cnfpwd);
        ...
        protected void onPostExecute(String result)
        {
            ...
            try {
                ...
                if(response_string.equals("Done User added!")){
                    Intent login_pg = new Intent(Signup.this,LoginActivity.class);
