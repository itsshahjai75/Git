...
import com.emoji.me_emoji.keyboard.emojicon.emoji.Nature;
import com.emoji.me_emoji.keyboard.emojicon.emoji.Objects;
import com.emoji.me_emoji.keyboard.emojicon.emoji.People;
import com.emoji.me_emoji.keyboard.emojicon.emoji.Places;
import com.emoji.me_emoji.keyboard.emojicon.emoji.Symbols;
...
public class EmojiconsFragment extends Fragment implements ViewPager.OnPageChangeListener {
    ...
    public static final void tempfragment() {
        image_emoji_layout.setVisibility(View.VISIBLE);
        emoji_layout.setVisibility(View.GONE);

        EmojiIconTempFragment f4 = new EmojiIconTempFragment();

        FragmentTransaction fragmentTransaction = fm.beginTransaction();
        fragmentTransaction.replace(R.id.image_emoji_layout, f4); // f2_container is your FrameLayout container
        fragmentTransaction.setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        fragmentTransaction.addToBackStack(null);
        fragmentTransaction.commit();
    }

    public static final void gallaryfragment() {
        image_emoji_layout.setVisibility(View.VISIBLE);
        emoji_layout.setVisibility(View.GONE);

        EmojiIconGallaryFragment f6 = new EmojiIconGallaryFragment();

        FragmentTransaction fragmentTransaction = fm.beginTransaction();
        fragmentTransaction.replace(R.id.image_emoji_layout, f6); // f2_container is your FrameLayout container
        fragmentTransaction.setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        fragmentTransaction.addToBackStack(null);
        fragmentTransaction.commit();
    }

    public static final void camerafragment(Bitmap bitmap) {
        image_emoji_layout.setVisibility(View.VISIBLE);
        emoji_layout.setVisibility(View.GONE);

        EmojiIconImageFragment f5 = new EmojiIconImageFragment();
        ...
        FragmentTransaction fragmentTransaction = fm.beginTransaction();
        fragmentTransaction.replace(R.id.image_emoji_layout, f5); // f2_container is your FrameLayout container
        fragmentTransaction.setTransition(FragmentTransaction.TRANSIT_FRAGMENT_OPEN);
        fragmentTransaction.addToBackStack(null);
        fragmentTransaction.commit();
    }
...
//	}
    ...
    public static void emojishow() {

        image_emoji_layout.setVisibility(View.GONE);
...
//        mEmojiTabs[6] = view.findViewById(R.id.img_chat_popup_captureimage);
        ...
        view.findViewById(R.id.img_chat_popup_addpicture).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mOnEmojiconBackspaceClickedListener != null) {
                    mOnEmojiconBackspaceClickedListener.onEmojiconGallaryClicked(v);
                }
            }
        });
        ...
        view.findViewById(R.id.img_chat_popup_captureimage).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mOnEmojiconBackspaceClickedListener != null) {
                    mOnEmojiconBackspaceClickedListener.onEmojiconCameraClicked(v);
                }
            }
        });

        view.findViewById(R.id.img_chat_popup_recoding).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mOnEmojiconBackspaceClickedListener != null) {
                    mOnEmojiconBackspaceClickedListener.onEmojiconAudioClicked(v);
                }
            }
        });
    ...
    public interface OnEmojiconBackspaceClickedListener {
        ...
        void onEmojiconGallaryClicked(View v);

        void onEmojiconCameraClicked(View v);

        void onEmojiconAudioClicked(View v);
    }
     ...
     * It cyclically runs a clickListener, emulating emoji_keyboard-like behaviour. First
