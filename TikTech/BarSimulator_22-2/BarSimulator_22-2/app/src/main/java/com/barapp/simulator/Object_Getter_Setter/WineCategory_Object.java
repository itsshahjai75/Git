...
public class WineCategory_Object implements Serializable{

    String id ,image_url , wine_name , price;
    boolean is_selected;

    public WineCategory_Object(String id ,String image_url, String wine_name, String price , boolean is_selected) {
        this.id = id;
